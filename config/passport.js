// config/passport.js scotch-mysql2
...
// user model, formerly in app/models/user.js
/*function User (id, token, email, name) {
	this.facebook_id = id;
	this.facebook_token = token;
	this.facebook_email = email;
...
module.exports = function(passport) {
    ...
    function(req, token, refreshToken, profile, done) {
				console.log ("mylog: FacebookStrategy");
        // asynchronous
        process.nextTick(function() {
				console.log ("mylog: process.nextTick");
            ...
            if (!req.user) {
                ...
                User.findOne({ 'facebook_id' : profile.id }, function(err, user) {
                 ...
                 /*   } else {
                        ...
                        var newUser            = new User(profile.id, token);
